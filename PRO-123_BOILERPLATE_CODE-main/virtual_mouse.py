...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		lilFinger_tip_x = int((landmarks[20].x) * width)
		lilFinger_tip_y = int((landmarks[20].y) * height)
		...
		cv2.line(image, (lilFinger_tip_x,lilFinger_tip_y), (thumb_tip_x,thumb_tip_y), (255,0,0), 2)
		...
		lilCenter_x = int((lilFinger_tip_x + thumb_tip_x) / 2)
		lilCenter_y = int((lilFinger_tip_y + thumb_tip_y) / 2)

		cv2.circle(image, (center_x,center_y), 2, (0,0,255), 2)
		cv2.circle(image, (lilCenter_x,lilCenter_y), 2, (0,0,255), 2)
		...
		print("Mouse position:", mouse.position, "center of the tips: ", center_x,center_y)

		lilDistance = math.sqrt(((lilFinger_tip_x - thumb_tip_x) **2) + ((lilFinger_tip_y - thumb_tip_y) **2))
		print("Distance is", lilDistance)

		print("Computer screen size: ", screen_width, screen_height, "Output window size: ",width, height)
		print("Mouse position:", mouse.position, "center of the tips: ", lilCenter_x, lilCenter_y)
